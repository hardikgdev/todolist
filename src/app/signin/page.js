      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-xl bg-gradient-to-br from-gray-900 to-gray-800 p-8 shadow-2xl">
        ...
        >
          ...
          <div className="space-y-4">
            ...
            >
              <Button onClick={handleGoogleSignIn} variant="outline" className="w-full bg-white/10 text-white hover:bg-white/20">
            ...
            >
              <Button onClick={handleGithubSignIn} variant="outline" className="w-full bg-white/10 text-white hover:bg-white/20">
          ...
          >
            ...
            <p className="text-gray-400">
              ...
              <Button variant="link" className="font-medium text-primary hover:underline" onClick={(() => router.push('/signup'))}>Sign Up</Button>
            </p>
          </motion.div>
        </motion.div>
      </div>
